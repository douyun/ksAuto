...
class KsAuto(object):
    ...
    def login_ks(self):
        self.driver.find_element(By.CSS_SELECTOR, 'input[placeholder=用户名]').send_keys('13961439600')
        self.driver.find_element(By.CSS_SELECTOR, 'input[placeholder=密码]').send_keys('meng2001')
    ...
    def to_common_page(self):
        for _ in range(3):
            try:
                folder1 = self.driver.find_element(By.XPATH, "//div[text()='分选模版']")
                folder1.click()
